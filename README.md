# nvim-treesitter-queries-textproto

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-textproto/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-textproto/actions/workflows/validate.yml)

Neovim tree-sitter queries for **textproto**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-textproto",
...
- [ ] Changes are scoped to `textproto` — do not include files for other languages
